...
- [加密数字货币恐怖融资监管：交易模式分析与异常实体识别](https://dik.whu.edu.cn/jwk3/tsqbzs/CN/10.13366/j.dik.2022.06.055)[J]. 颜嘉麒,**王佳鑫***,毛谦昂等. **图书情报知识(CSSCI,社科基金资助期刊)**,2022,39(6):55-66 [Translation: Cryptocurrency Terrorist Financing Regulation: Transaction Pattern Analysis and Abnormal Entity Identification[J]. Jiaqi Yan, **Jiaxin Wang***, Qian’ang Mao, et al. **Documentation, Information & Knowledge(CSSCI, National Social Science Foundation Journal)**,2022,39(6):55–66.]
...
- 参与一项国家自然科学基金面上项目——面向"隐匿-抗毁"的黑灰产加密货币交易网络动态角色识别与最优瓦解分析(No. 72571131, 2026-2029) [Translation: Participant in National Natural Science Foundation of China (NSFC) General Program: "Dynamic Role Identification and Optimal Dismantling Analysis of Covert and Resilient Black/Gray Market Cryptocurrency Trading Networks" (No. 72571131, 2026–2029)]
- 参与一项国家自然科学基金面上项目——恐怖主义数字货币融资交易实体角色识别与知识图谱分析方法研究(No. 72171115, 2021-2025) [Translation: Participant in National Natural Science Foundation of China (NSFC) General Program: "Research on Entity Role Identification and Knowledge Graph Analysis Methods for Terrorist Digital Currency Financing Transactions" (No. 72171115, 2021–2025)]
...
- [基于超图的引文推荐方法及电子设备](https://pss-system.cponline.cnipa.gov.cn/documents/detail?prevPageTit=changgui)[P] (No. CN120524006A). 颜嘉麒;柳亚;朱莉;**王佳鑫**;毛谦昂;胡广伟. 2025-09-26 [Translation: Citation Recommendation Method and Electronic Device Based on Hypergraph. Yan, J., Liu, Y., Zhu, L., **Wang, J.**, Mao, Q., & Hu, G. China Patent No. CN120524006A. Published September 26, 2025.]
